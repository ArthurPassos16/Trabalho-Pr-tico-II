...
public class AVLTree<Key extends Comparable<Key>, Value> {
    ...
    //O filho direito de 'no' sobe e
    // 'no' se torna filho dele como um filho a esquerda
    ...
    private Node rotacaoDireita(Node no) {
        ...
        novaRaiz.altura = 1 + Math.max(altura(novaRaiz.dir), altura(novaRaiz.esq));
